...
const StartQuiz = () => {
  ...
  return (
    <div className='form-page dashboard-container'>
      <Container maxWidth="lg" sx={{ margin:'150px 0px 0px 200px' }}>
        ...
        <div className='form-main-container' class="container">
          <div class="row">
            <div class="col">
            <form className='my-form' onSubmit={handleStartQuiz}>
